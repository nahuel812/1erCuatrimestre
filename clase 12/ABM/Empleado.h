...
void altaEmpleado(eEmpleado listaEmpleados[], int tEmpleados, eSector[],int );
int borrarEmpleado(eEmpleado[],int, eSector[],int );
int modificarEmpleado(eEmpleado[], int, eSector[],int);

float buscarSueldoMaximo(eEmpleado[],int);
void mostrarEmpleadosConSueldoMaximo(eEmpleado[],int, eSector[],int );
int contarCarlos(eEmpleado lista[], int tam);

eSector buscarSectorPorId(eSector[],int tSector ,int idSector);

void mostrarSectorConSusEmpleados(eEmpleado[],int,eSector[],int);
