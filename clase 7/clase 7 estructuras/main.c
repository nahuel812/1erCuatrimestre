...
int main()
{
    //creo empleados con la estructura
    ...
    otroEmpleado = unEmpleado;//las estructuras tienen la propiedad de asignacion, puedo asignar toda una estructura a otra mientras tengan los mismos campos
